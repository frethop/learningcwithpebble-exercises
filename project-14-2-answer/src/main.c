//----------------------------------------------------------------------------------
//
// Project 14.2 from "Learning C with Pebble"
//
// Johannes Neubrand, June 2016
//
...
enum Clock {CLOCKWISE=-1, COUNTER_CLOCKWISE=1};
...
static void tap_handler(AccelAxisType axis, int32_t direction) {
    if (axis == ACCEL_AXIS_Y) {
         change_snake_direction(direction > 0 ? COUNTER_CLOCKWISE : CLOCKWISE);
    }
}
