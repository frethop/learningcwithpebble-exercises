...
// Declarations for Pebble graphics
static Window *window;
static Layer *bouncy_layer;
static GRect window_frame;

// Declarations for the letter
...
// When the middle button is pressed, change direction
static void select_click_handler(ClickRecognizerRef recognizer, void *context) {
    direction = direction * -1;
}

// When the up button is pressed, change the letter and speed up.
...
// When the down button is pressed, change the letter and slow down
...
// This function recomputes the position of the letter in terms of position_x and position_y
